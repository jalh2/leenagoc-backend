...
router.post('/:id/images', requireAuth, addServiceImage); // Removed upload.single('image'), using addServiceImage

// @route   DELETE /api/services/:serviceId/images/:imageId
// @desc    Delete an image from a service
// @access  Private (Admin)
router.delete('/:serviceId/images/:imageId', requireAuth, deleteServiceImage);

// @route   PUT /api/services/:serviceId/images/:imageId/primary
// @desc    Set an image as primary for a service
// @access  Private (Admin)
router.put('/:serviceId/images/:imageId/primary', requireAuth, setPrimaryServiceImage);
